    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url("index.php/Benevoles/index"); ?>">Accueil</a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url("index.php/Benevoles/profil"); ?>">Infos sur mon compte</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo base_url("index.php/Benevoles/deconnexion"); ?>">Se déconnecter</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url("index.php/Benevoles/liste_participation"); ?>">Mes Participations</a></li>
