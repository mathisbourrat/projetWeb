...
<div class="container">
    ...
    <div id="body">
        <h3>Retrouvez ici les événements en vogue!</h3>
            ...
            <div class="carousel-inner"> 
                <div class="item active">
                    ...
                    <div class="carousel-caption"> 
                        ...
                        <a href="<?php echo base_url("index.php/AccueilCtrl/afficher_event/" . $event[0]->idEvent); ?>" ><p><button class="btn btn-primary">Plus d’informations</button></p></a> 
                ...
                <div class="item"> 
                    ...
                    <div class="carousel-caption">
                        ...
                        <a href="<?php echo base_url("index.php/AccueilCtrl/afficher_event/" . $event[1]->idEvent); ?>" ><p><button class="btn btn-primary">Plus d’informations</button></p></a> 
                ...
                <div class="item" style='text-align: center'> 
                    ...
                    <div class="carousel-caption"> 
                        ...
                        <a href="<?php echo base_url("index.php/AccueilCtrl/afficher_event/" . $event[2]->idEvent); ?>" ><p><button class="btn btn-primary">Plus d’informations</button></p></a> 
                    </div> 
                </div> 
            </div> 
